    ...
    return (
        <section className="max-w-7xl mx-auto px-4 md:px-10 mb-32 scroll-mt-32" id="testimonials">
            <div className="text-center mb-16">
                <h2 className="text-primary font-bold uppercase tracking-[0.3em] text-sm mb-4">Témoignages</h2>
                <h3 className="font-display text-4xl md:text-5xl font-bold text-deep-brown tracking-tight">Ce que disent les propriétaires</h3>
            </div>
